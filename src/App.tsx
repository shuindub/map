...
// --- NEW ASSISTANT MODULE ---
import { AssistantProvider, AssistantOverlay } from './assistant';
...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case Tab.TOOLS:
        return <ToolsCatalog settings={settings} setActiveTab={setActiveTab} />;
